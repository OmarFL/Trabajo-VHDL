...
REM
REM Generated by Vivado on Fri Jan 02 16:15:33 +0100 2026
...
echo "xvhdl --incr --relax -prj Input_Conditioner_tb_vhdl.prj"
call xvhdl  --incr --relax -prj Input_Conditioner_tb_vhdl.prj -log xvhdl.log
