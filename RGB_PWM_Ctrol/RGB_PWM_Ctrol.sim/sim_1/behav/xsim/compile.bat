...
REM
REM Generated by Vivado on Sun Dec 28 19:28:16 +0100 2025
...
echo "xvhdl --incr --relax -prj RGB_Controller_tb_vhdl.prj"
call xvhdl  --incr --relax -prj RGB_Controller_tb_vhdl.prj -log xvhdl.log
